// Bu dosya Create React App'in service worker kaydı için standart şablondur.
// Daha fazla bilgi: https://cra.link/PWA
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log(
            'Bu web uygulaması, hızlı yüklenme için önbelleğe alınmış dosyaları kullanıyor.'
          );
        });
      } else {
